-- Migration: Fix create_meeting_with_agenda to include speaker_id
-- The INSERT statement was missing the speaker_id column, causing check constraint violation
-- when creating meetings with speaker items (check_speaker_has_fk constraint)
