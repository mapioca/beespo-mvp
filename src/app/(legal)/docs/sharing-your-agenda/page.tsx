    ...
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <section className="mb-10">
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-xl font-medium mb-2">Step 1: Open the Share Dialog</h3>
            <p className="text-muted-foreground">
          ...
          <div>
            <h3 className="text-xl font-medium mb-2">Step 2: Copy the Link</h3>
            <p className="text-muted-foreground">
          ...
          <div>
            <h3 className="text-xl font-medium mb-2">Step 3: Export Options</h3>
      ...
      <section className="mb-10 bg-primary/5 p-6 rounded-lg border border-primary/10">
        <h2 className="text-2xl font-semibold mb-4">Privacy & Access</h2>
