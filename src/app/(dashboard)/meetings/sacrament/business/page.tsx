...
export default async function BusinessPage() {
  ...
  const { data: businessItems, error } = await (
    ...
    .select(
      "id, person_name, position_calling, category, status, action_date, notes, details, created_at, updated_at, workspace_id, created_by, creator:profiles!created_by(full_name)"
    )
