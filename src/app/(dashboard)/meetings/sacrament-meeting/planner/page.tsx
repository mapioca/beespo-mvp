    ...
    <div className="min-h-full">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        <section className="space-y-1">
          <h1 className="text-2xl font-semibold tracking-tight">Sacrament Meeting Planner</h1>
          <p className="text-sm text-muted-foreground">
            Planner is the default view for sacrament meeting.
          </p>
        </section>
        ...
        <Card className="border-border/70">
          <CardHeader>
            ...
            <CardDescription>
              Add bishopric-specific sacrament meeting planning tools here.
            </CardDescription>
          </CardHeader>
