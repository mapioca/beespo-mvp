...
export function ToolboxPane({ onItemsLoaded }: ToolboxPaneProps) {
    ...
    const t = useTranslations("Dashboard.Meetings.builder.toolbox");
    ...
    return (
        <div className="flex flex-col h-full bg-muted/50 border-r border-border">
            ...
            <div className="p-4 border-b border-border bg-background">
                <h3 className="font-semibold text-sm mb-3 text-foreground">{t("itemLibrary")}</h3>
