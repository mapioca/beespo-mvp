...
>(({ className, type = "button", ...props }, ref) => (
  <button
    ...
    type={type}
    className={cn(
      "inline-flex h-[var(--agenda-icon-control-size)] w-[var(--agenda-icon-control-size)] items-center justify-center rounded-full border border-border text-muted-foreground transition-colors shrink-0",
