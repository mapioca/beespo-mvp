...
export function StandardSelectableRow({
  ...
  return (
    <TableRow
      ...
      className={cn(
        "group transition-[background-color,box-shadow] duration-150 ease-out bg-surface-raised hover:bg-surface-hover data-[state=selected]:bg-[var(--table-row-bg-selected)] data-[state=selected]:hover:bg-[var(--table-row-bg-selected-hover)] data-[state=selected]:focus-within:bg-[var(--table-row-bg-selected-hover)]",
